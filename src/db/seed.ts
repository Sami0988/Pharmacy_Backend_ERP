...
async function seed() {
  ...
  const notificationsData = [
    ...
    { type: 'near_expiry' as const, title: 'Near Expiry Warning', message: 'Batch BAT-DEX-001 expires in 6 months (Dexamethasone 0.5mg)', batchId: createdBatches[12].id, thresholdDays: 180 },
    { type: 'near_expiry' as const, title: 'Near Expiry Warning', message: 'Batch BAT-LOS-001 expires in 9 months (Losartan 50mg)', batchId: createdBatches[16].id, thresholdDays: 270 },
